...
CREATE TABLE `mimo_article` (
  ...
  KEY `channel_id` USING BTREE (`channel_id`),
  KEY `create_time` USING BTREE (`create_time`),
  KEY `tags` USING BTREE (`tags`),
  KEY `status` USING BTREE (`status`),
  KEY `empty_photos` USING BTREE (`not_empty_photos`),
...
CREATE TABLE `mimo_article_attachment` (
  ...
  PRIMARY KEY  (`id`),
  UNIQUE KEY `id` USING BTREE (`id`),
  KEY `article_id` USING BTREE (`article_id`),
...
CREATE TABLE `mimo_channel` (
  ...
  PRIMARY KEY  (`id`),
  UNIQUE KEY `id` USING BTREE (`id`),
  UNIQUE KEY `path` USING BTREE (`path`),
  KEY `father_id` USING BTREE (`father_id`),
...
-- ----------------------------
INSERT INTO `mimo_monitoring_record` VALUES ('1', 'admin', '修改用户', '127.0.0.1', '/mimo/security/user/373b4947553c11e1badbc8b1208a5409/edit/', '1399218608671', '234');
...
CREATE TABLE `mimo_security_authority` (
  ...
  UNIQUE KEY `permission` USING BTREE (`permission`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `mimo_security_role_authority` (
  ...
  KEY `authority_id` USING BTREE (`authority_id`),
...
CREATE TABLE `mimo_security_user` (
  ...
  KEY `account_non_locked` USING BTREE (`account_non_locked`),
  KEY `father_id` USING BTREE (`father_id`),
...
-- ----------------------------
INSERT INTO `mimo_security_user` VALUES ('373b4947553c11e1badbc8b1208a5409', 'admin', '9v3/5IyQjesPTDvTbAMucg==', '', '373b4947553c11e1badbc8b1208a5409');
...
INSERT INTO `mimo_security_user_role` VALUES ('373b4947553c11e1badbc8b1208a5409', 'b1e377a15cfd11e195de360472309768');
